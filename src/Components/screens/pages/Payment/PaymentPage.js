            ...
            <div className={Styles.MyCurrentPlanContainer}>
                ...
                <div className={Styles.MyCurrentPlanContainerContent}> 
                    ...
                    <div className={Styles.MyCurrentPlan}>
                        ...
                        <div className={Styles.MyCurrentPlanBasicWithADSContent}>
                            <p className={Styles.MyCurrentPlanBasicWithADSContentText}>20 August 2022</p>
                        </div>
                    </div>
                    <div className={Styles.MyCurrentPlan}>
                        <p className={Styles.MyCurrentPlanText}>Paid</p>
                        <div className={Styles.MyCurrentPlanBasicWithADSContent}>
                            <p className={Styles.MyCurrentPlanBasicWithADSContentText}>$120 monthly</p>
                        </div>
                    </div>
            ...
            <div className={Styles.PaymentMethodsContainer}>
                ...
                {Data.map((data)=> (
                    <tr className={Styles.TableBody} key={data.id}>
                        <RectangleGreyIcon/>
                        <td className={Styles.TankName}>{data.TankName}<p className={Styles.TankNameUSD}>USD</p></td>
                        <td className={Styles.TankName}>{data.WaterLevel}</td>
                        <td className={Styles.TankName}>{data.LastRefil}</td>
                        <td className={Styles.TankName}>{data.NextMaintainence}</td>
                        <td className={Styles.TankName}>{data.LastUpdated}</td>
